...
│   │   ├── Card.js           # Base card class (275 lines)
│   │   ├── Die.js            # Die with face-specific enhancements (320 lines)
│   │   ├── Joker.js          # Boon cards (761 lines)
│   │   ├── LibationCard.js   # Consumable libations (682 lines)
...
│   │   └── Logger.js         # **NEW** Centralized logging system
│   │
...
### 1. GameEngine (js/game/GameEngine.js)
...
### 2. UIManager (js/ui/UIManager.js)
...
All game balance is now in `js/config/` constants:

```javascript
// Easy to tweak game balance
GAME_BALANCE.STARTING_GOLD = 20;  // Was 15
GAME_BALANCE.SHOP_REROLL_COST = 3;  // Was 2
SCORING.YAHTZEE_BASE = 60;  // Was 50
```
...
- **DEVELOPMENT_PIPELINE.md** - Full development roadmap
- **PHASE_3_MASTER_PLAN.md** - Phase 3 detailed plan
- **BUGS_FIXED_LOG.md** - Historical bug fixes
- **card_database.csv** - Original card data source
