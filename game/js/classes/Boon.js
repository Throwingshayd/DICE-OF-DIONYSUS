...
class Boon extends Card {
    constructor(data) {
        super(data);
        this.type = 'boon';
        this.triggers = data.triggers || ['score']; // When this boon activates
        ...
        switch (this.id) {
            ...
            case 'the_gambler':
                ...
                if (gamblerBonus > 0) {
                    ...
                    this.dynamicStats.pips = gamblerBonus;
            ...
            case 'the_symposium':
                ...
                if (hasFourOfKind) {
                    ...
                    const s = Math.round(this.symposiumFavourStacks * 10) / 10;
            ...
            case 'doubling_season':
                ...
                this.dynamicStats.pips = seasonAdjustment;
                break;
            ...
            case 'nyxian_seduction':
                ...
                if (result.category === 'Chance') {
                    ...
                    const targetPool = this._getPrng()?.random() < 0.75 ? maleGods : femaleGods;
                    const seducedGod = targetPool[this._randomInt(targetPool.length)];
            ...
            default:
                ...
                Logger.warn(`Unknown boon effect: ${this.id} - this boon may not function correctly`);
