...
> **Location:** .cursor/context/ (agent reference)  
...
```javascript
Starting Gold: 6
Base Reroll Cost: 4g (1 free reroll per ante)
...
- **This file:** .cursor/context/BALATRO_DESIGN_PRINCIPLES.md
- **Boon reference:** .cursor/context/CONSOLIDATED_BOON_REFERENCE.md
- **Development workflow:** .cursor/context/development_workflow.md
