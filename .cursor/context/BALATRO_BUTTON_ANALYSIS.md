...
#### 1. **Visibility/Opacity Issues** ✅ FIXED
```css
...
#### 2. **Inconsistent Positioning** ✅ FIXED (Sell=left, Buy=right per Balatro card_focus_button)
```css
...
#### 3. **Size Inconsistencies** ✅ FIXED (consistent min-width, no inventory shrink)
```css
/* Default size */
.buy-sell-label {
    padding: 8px 16px;
