...
class BalatroEffects {
    ...
    parseTooltipData(data) {
        try {
            ...
            if (parsed.rarity) {
                const rarityColor = this.getRarityColor(parsed.rarity);
                html += `<div class="tooltip-rarity" style="color: ${rarityColor};">${parsed.rarity.toUpperCase()}</div>`;
            }
            ...
            if (parsed.god) {
                html += `<div class="tooltip-god">God: ${parsed.god}</div>`;
            }
            ...
            if (parsed.sellValue) {
                html += `<div class="tooltip-sell">Sell: ${parsed.sellValue}g</div>`;
            }
            ...
            if (parsed.type) {
                ...
                html += `<div class="tooltip-type">Type: ${typeName}</div>`;
            }
